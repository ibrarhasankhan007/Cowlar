...
*/
#define EXAMPLE_WIFI_SSID             "Swat"
#define EXAMPLE_WIFI_PASS             "khan1122"
#define EXAMPLE_MAXIMUM_RETRY         CONFIG_EXAMPLE_MAXIMUM_RETRY
#define EXAMPLE_STATIC_IP_ADDR        "192.168.1.155"
#define EXAMPLE_STATIC_NETMASK_ADDR   CONFIG_EXAMPLE_STATIC_NETMASK_ADDR
#define EXAMPLE_STATIC_GW_ADDR        "192.168.1.0"
...
#define HOST_IP_ADDR "192.168.1.55"
#define PORT 60265
...
//    char host_ip[] = HOST_IP_ADDR;
    ...
    while (1) {
        ...
        while (1) {
            ...
            int err = sendto(sock, &adc_reading, 1, 0, (struct sockaddr *)&dest_addr, sizeof(dest_addr));
            if (err < 0) {
...
void app_main(void)
{
    ...
    xTaskCreate(IR_read_init, "IR_read", 4096, NULL, 5, NULL);
}
